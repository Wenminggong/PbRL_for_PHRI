...
from decoupled_on_policy_with_reward_algorithm import DecoupledOnPolicyRewardAlgorithm
from stable_baselines3.common.policies import ActorCriticPolicy
from stable_baselines3.common.type_aliases import GymEnv, MaybeCallback, Schedule
from stable_baselines3.common.utils import explained_variance, get_schedule_fn


class DecoupledPrefPPO(DecoupledOnPolicyRewardAlgorithm):
    """
    ...
    def __init__(
        ...
        super(DecoupledPrefPPO, self).__init__(
            reward_model,
            policy,
            env,
            ...
            reward_decay_type=reward_decay_type,
            reward_decay_rate=reward_decay_rate,
            reward_rou=reward_rou,
        )
    ...
    def _setup_model(self) -> None:
        super(DecoupledPrefPPO, self)._setup_model()
    ...
    def learn(
        ...
        tb_log_name: str = "SeparateRewardPrefPPO",
        ...
        if unsuper_flag:
            return super(DecoupledPrefPPO, self).learn_unsuper(
        ...
        return super(DecoupledPrefPPO, self).learn(
            total_timesteps=total_timesteps,
            callback=callback,
            log_interval=log_interval,
            eval_env=eval_env,

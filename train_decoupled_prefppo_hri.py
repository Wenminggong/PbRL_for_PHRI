...
train a policy for HRI in assistive-gym using decoupled preference-based ppo
"""
...
from decouple_task_and_preference_prefppo import DecoupledPrefPPO
...
if __name__ == "__main__":
    ...
    parser.add_argument("-tb", "--tensorboard-log", help="Tensorboard log dir", default="logs/DecoupledPrefPPO_test/", type=str)
    ...
    parser.add_argument("--reward-rou", type=float, default=0.0001)

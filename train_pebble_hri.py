...
train a policy for HRI in assistive-gym using PEBBLE
"""
...
from separate_reward_pebble import SeparateRewardPEBBLE
...
if __name__ == "__main__":
    ...
    parser.add_argument("-tb", "--tensorboard-log", help="Tensorboard log dir", default="logs/PEBBLE_test/", type=str)

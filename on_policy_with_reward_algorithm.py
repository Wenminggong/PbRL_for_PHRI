...
class OnPolicyRewardAlgorithm(BaseAlgorithm):
    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            if self.reward_flag == 'total_reward':
                train_rewards = rewards[:, 0] + rewards[:, 1]
                ...
                if len(self.ep_info_buffer) > 0 and len(self.ep_info_buffer[0]) > 0:
                    ...
                    for idx, info in enumerate(infos):
                        ...
                        if maybe_ep_info is not None:
                            ep_reward.append(maybe_ep_info["total_reward"])
    ...
    def learn_unsuper(
        ...
        while self.num_timesteps < total_timesteps + self.unsuper_step:

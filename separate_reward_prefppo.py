'''
copy from B-Pref: https://github.com/pokaxpoka/B_Pref/blob/main/stable_baselines3/ppo/ppo_with_reward.py
'''
...
class SeparateRewardPrefPPO(SeparateRewardOnPolicyRewardAlgorithm):
    ...
    def _setup_model(self) -> None:
        super(SeparateRewardPrefPPO, self)._setup_model()
    ...
    def learn(
    ...
    ) -> "SeparateRewardPrefPPO":
        
        if unsuper_flag:
            return super(SeparateRewardPrefPPO, self).learn_unsuper(
        ...
        return super(SeparateRewardPrefPPO, self).learn(
            total_timesteps=total_timesteps,
            callback=callback,
            log_interval=log_interval,
            eval_env=eval_env,

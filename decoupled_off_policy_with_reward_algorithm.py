...
from new_buffers import ReplayBuffer
...
class DecoupledOffPolicyRewardAlgorithm(OffPolicyAlgorithm):
    """
    The base for Off-Policy algorithms (ex: SAC/TD3) with reward learning for decoupled task and preference
    :param reward model
    ...
    def __init__(
        ...
        super(DecoupledOffPolicyRewardAlgorithm, self).__init__(
            policy = policy,
            env = env,
    ...
    def _setup_model(self):
        super(DecoupledOffPolicyRewardAlgorithm, self)._setup_model()
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            while not done:
                ...
                task_reward = reward[:, 1] # np.array([reward])
                ...
                self._store_transition(replay_buffer, action, new_obs, pred_reward, task_reward, dones, infos)
    ...
    ) -> "DecoupledOffPolicyRewardAlgorithm":
